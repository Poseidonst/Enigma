...
for plug in listname:
    ...
    for i in input:
        ...
        WEL_L = []
        WEL_M = []
        WEL_LIST = [Lijst_eerste, WEL_A, WEL_B, WEL_C, WEL_D, WEL_E, WEL_F, WEL_G, WEL_H, WEL_I, WEL_J, WEL_K, WEL_L,]
        ...
        if input.index(i) == 0:
            ...
            for x in WEL_LIST:
                ...
                for n in x:
                    ...
                    if enigma(input[WEL_LIST.index(x) + 1], rotorI, rotorII, rotorIII, reflectorB, (count1 + WEL_LIST.index(x) + 1) % 26, count2, count3, plugdiction) == GW[WEL_LIST.index(x) + 1] or enigma(input[WEL_LIST.index(x) + 1], rotorI, rotorII, rotorIII, reflectorB, (count1 + WEL_LIST.index(x) + 1) % 26, (count2 + 1) % 26, count3, plugdiction) == GW[WEL_LIST.index(x) + 1]:
                        if LC == 0:
                            WEL_A.append(n)
                        elif LC == 1:
                            WEL_B.append(n)
