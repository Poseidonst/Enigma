...
def BruteForce():
    ...
    for i in range(26):
        for j in range(26):
            for k in range(26):
                value = CrackTest("WETTERBERICHT", "CRCYOQQNNCGWX", i, j, k)
    ...
    try:
        ...
        print(len(counterdict[maximum - 1]))
    except:
        pass
    try:
        print()
        print(counterdict[maximum - 2])
        print(len(counterdict[maximum - 2]))
    except:
        pass
    try:
        print()
        print(counterdict[maximum - 3])
        print(len(counterdict[maximum - 3]))
    except:
        pass
    try:
        print()
        print(counterdict[maximum - 4])
        print(len(counterdict[maximum - 4]))
    except:
        pass
